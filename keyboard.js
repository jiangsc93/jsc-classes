...
class Keyboard {
    constructor(options) {
        this[_options] = object.objectMerge(o(), defaults, options);
        this[_bindingList] = [];
    ...
    [_unbindOne](shortcuts, handler) {
        ...
        if (!handlers)
            return;
        array.arrayRemove(handlers, (el) => el === handler);
    }
...
exports.getKeyCodeByName = getKeyCodeByName;
exports.getKeyNamesByCode = getKeyNamesByCode;
