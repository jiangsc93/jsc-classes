import { arrayRemove as arrayRemove_1 } from './node_modules/jsc-utils/array.mjs';
import { objectMerge } from './node_modules/jsc-utils/object.mjs';
...
class Keyboard {
    ...
    [_unbindOne](shortcuts, handler) {
        ...
        if (!handlers)
            return;
        arrayRemove_1(handlers, (el) => el === handler);
    }
